...
class Hyperparameters:
    # data hyperparams
    input_bin : str = '/mnt/rd/dataset/fineweb_train_*.bin' # input .bin to train on
    input_val_bin : str = '/mnt/rd/dataset/fineweb_val_*.bin' # input .bin to eval validation loss on
...
if os.environ.get('RANK') is None:  # single GPU training
    ddp_rank = 0
    ddp_local_rank = 0
    ddp_world_size = 1
    device = 'cuda:0'
